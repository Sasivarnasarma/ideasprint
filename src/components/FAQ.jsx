            ...
            <div className="container" style={{ position: 'relative', zIndex: 2 }}>
                <div className="text-center mb-5">
                    <h2 className="section-title">
                        F A <span className="accent">Q</span>
                    </h2>
                ...
                <div className="faq-dashboard-grid">
                        ...
                        {faqData.map((faq) => (
                            <div key={faq.id} className="faq-accordion-container">
                                ...
                                >
                                    ...
                                    <span
                                        className={`faq-tab-icon ${activeId === faq.id ? 'open' : ''}`}
                                    >
                                        <svg
                                            width="20"
                                            height="20"
                                ...
                                <div
                                    className={`faq-mobile-answer ${activeId === faq.id ? 'expanded' : ''}`}
                                >
                    ...
                    <div className="faq-answer-panel">
                        {activeFaq ? (
                            ...
                            >
                                <p className="faq-answer-text" style={{ opacity: 0.5 }}>
                                    Select a question to view its detailed answer.
                                </p>
                            </div>
                        )}
                    </div>
