                ...
                <div className="footer-grid">
                    <div className="footer-col brand-col">
                        ...
                        <p className="footer-desc">
                            ...
                            Science Students' Association. Collaborate, explore real-world
                            challenges, and develop innovative technology-driven solutions.
                        </p>
                    ...
                    <div className="footer-col links-col">
                        ...
                        <ul className="footer-links">
                            ...
                            <li>
                                <a href="#timeline">
                                    <span className="link-arrow">&gt;</span> Timeline
                                </a>
                            </li>
                            <li>
                                <a href="#contact">
